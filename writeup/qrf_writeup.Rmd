...
The distribution of capacity predictions within each geomorphic reach is shown in Figure \@ref(fig:violin-p). Figures \@ref(fig:lem-map) are maps depicting the average capacity within each geomorphic reach.
...
```{r violin-p, fig.cap = "Violin plots showing the distribution of capacity estimates for 200 m reaches within each geomorphic reach in each watershed."}
gr_cap_df %>%
